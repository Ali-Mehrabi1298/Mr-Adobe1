    ...
    public partial class Addtable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Filesses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryToproducts_Product_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderDetailID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    orderIdd = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ProductId", "Free", "Price", "Text", "Title" },
                values: new object[,]
                {
                    { 1, false, 200000, "دوره  پروژه محور اکولایزر ", "اکولایزر " },
                    { 2, false, 158000, "دوره پروژه محور افتر افکت", "افترافکت" }
                });
